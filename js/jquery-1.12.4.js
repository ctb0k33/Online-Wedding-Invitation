...
!(function (e, t) {
  ...
  function _e(e, t, n, r) {
    ...
    if (
      ...
      for (s = (l = p.map(ae(c, "script"), je)).length; d < h; d++)
        (a = c),
          d !== g &&
            ((a = p.clone(a, !0, !0)), s && p.merge(l, ae(a, "script"))),
          n.call(e[d], a, d);
      if (s)
  ...
  p.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (r = ae(o, "script")).length > 0 && se(r, !l && ae(e, "script")),
        (r = s = i = null),
        o
      );
    },
  ...
  !(function () {
    ...
    function c() {
      ...
      d.appendChild(l),
        ...
        (n = a = !0),
        e.getComputedStyle &&
          ((f = e.getComputedStyle(u)),
          (t = "1%" !== (f || {}).top),
          (s = "2px" === (f || {}).marginLeft),
          (i = "4px" === (f || { width: "4px" }).width),
          (u.style.marginRight = "50%"),
          (n = "4px" === (f || { marginRight: "4px" }).marginRight),
          ((c = u.appendChild(r.createElement("div"))).style.cssText =
            u.style.cssText =
  ...
  function bt(e, t, n) {
    ...
    for (
      ...
      if ((r = bt.prefilters[o].call(u, e, c, u.opts)))
        return (
          p.isFunction(r.stop) &&
            (p._queueHooks(u.elem, u.opts.queue).stop = p.proxy(r.stop, r)),
          r
        );
    return (
      p.map(c, xt, u),
        ...
        for (w = "", this.maxRows = 4, T = 0; K[1] > T; T++) {
          ...
          for (
            M += N + "</tr></thead><tbody>",
              ...
              I = Math.ceil((P + A) / 7),
              H = U ? (this.maxRows > I ? this.maxRows : I) : I,
              this.maxRows = H,
            ...
            for (
              ...
              (E = g ? g.apply(e.input ? e.input[0] : null, [z]) : [!0, ""]),
                (O = z.getMonth() !== Z),
                (W = (O && !y) || !E[0] || (X && X > z) || ($ && z > $)),
                (j +=
                  "<td class='" +
